...
#define __stifont(idx) __attribute__((section(".sti.font." #idx)))
...
static struct font __stifont(1) __aligned(32) sti_rom_font = {
    .hdr = {
        .first_char = 0,
        .last_char = 255,
        .width = 8,
...
static struct font __stifont(2) __aligned(32) sti_rom_font32 = {
    .hdr = {
        .first_char = 0,
        .last_char = 255,
        .width = 16,
...
#define STI_FONT_OFFSET(_x) ((u32)&(_x) - (u32)&sti_rom_font)
...
void sti_rom_init(void)
{
    ...
    /* chain fonts */
    sti_rom_font.hdr.next_font = STI_FONT_OFFSET(sti_rom_font32);
